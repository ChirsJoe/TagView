...
@property (nonatomic,strong) UIButton *gapButton;
 ...
 *  占位标签背景图片
 */
@property (nonatomic, strong) UIImage *gapButtonBackgroundImage;
 ...
 *  点击标签，执行Block
 */
@property (nonatomic, strong) void(^clickTagBlock)(YZTagButton *tag);
